...
function download_packages {
  ...
  sudo mkdir tmp
  sudo qemu-debootstrap --arch=$ARCHEX $RELEASE tmp/
  echo "deb http://ports.ubuntu.com/ubuntu-ports $RELEASE main restricted universe" > sources.list
  echo "deb-src http://ports.ubuntu.com/ubuntu-ports $RELEASE main restricted universe" >> sources.list
